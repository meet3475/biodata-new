                    ...
                    <div className='flex justify-between'>
                        <div className='flex gap-7'>
                            <div className='flex items-center justify-center'>
                                ...
                                <span className='text-[14px] text-[#ffff] hover:text-[#75AAA0] ml-1 Montserrat-font'>(+245) 592 1125</span>
                            </div>
                            ...
                            <div className='flex items-center justify-center'>
                                ...
                                <span className='text-[14px] text-[#ffff] hover:text-[#75AAA0] ml-1 Montserrat-font'>rrdevs@support.com</span>
                            </div>
                        </div>
                        ...
                        <div className='flex'>
                            ...
                            <div className='text-[#fff] hover:text-[#75AAA0] px-2.5'>
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M10.8001 5.42102C11.914 5.42102 12.9823 5.88681 13.7699 6.71592C14.5576 7.54503 15.0001 8.66954 15.0001 9.84207V15H12.2001V9.84207C12.2001 9.45123 12.0526 9.07639 11.79 8.80002C11.5275 8.52365 11.1714 8.36839 10.8001 8.36839C10.4288 8.36839 10.0727 8.52365 9.81015 8.80002C9.5476 9.07639 9.4001 9.45123 9.4001 9.84207V15H6.6001V9.84207C6.6001 8.66954 7.0426 7.54503 7.83025 6.71592C8.6179 5.88681 9.68619 5.42102 10.8001 5.42102Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                                    <path d="M3.8 6.1579H1V15H3.8V6.1579Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                                    <path d="M2.4 3.94737C3.1732 3.94737 3.8 3.28758 3.8 2.47368C3.8 1.65979 3.1732 1 2.4 1C1.6268 1 1 1.65979 1 2.47368C1 3.28758 1.6268 3.94737 2.4 3.94737Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                                </svg>
                            </div>
                            <div className='text-[#fff] hover:text-[#75AAA0] px-2.5'>
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M11.5 1H4.5C2.567 1 1 2.567 1 4.5V11.5C1 13.433 2.567 15 4.5 15H11.5C13.433 15 15 13.433 15 11.5V4.5C15 2.567 13.433 1 11.5 1Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                                    <path d="M10.7997 7.55897C10.8861 8.14154 10.7866 8.73652 10.5153 9.25928C10.2441 9.78204 9.8149 10.206 9.28884 10.4707C8.76277 10.7355 8.16661 10.8277 7.58515 10.7341C7.00368 10.6406 6.46653 10.366 6.05008 9.94958C5.63364 9.53313 5.35911 8.99598 5.26554 8.41452C5.17198 7.83305 5.26414 7.23689 5.52893 6.71083C5.79371 6.18476 6.21763 5.75559 6.74039 5.48434C7.26315 5.21309 7.85813 5.11358 8.4407 5.19997C9.03494 5.28809 9.58509 5.56499 10.0099 5.98978C10.4347 6.41457 10.7116 6.96472 10.7997 7.55897Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                                    <path d="M11.8501 4.14996H11.8571" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                                </svg>
                            </div>
                        </div>
                    ...
                    <>
                            ...
                            <div className="flex justify-between h-16 items-center">
                                    ...
                                    <div className="hidden md:flex space-x-6">
                                        {navigation.map((item) => (
                                            <a key={item.name} href={item.href} className={classNames(
                                                'text-[#1b7261] font-medium text-[16px] p-[18px] hover:text-[#051145] Montserrat-font'
                                            )}>{item.name}</a>
                                        ))}
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-4">
                                    {pathname === '/' ? (
                                        ...
                                        >
                                            <span className='Montserrat-font'>Create Biodata</span>
                                        </button>
                                    ) : (
                                        <Link href="/">
                                            <button className="rr-btn hidden md:block"
                        ...
                        <DisclosurePanel className="md:hidden">
                            <div className="space-y-1 px-2 pt-2 pb-3">
                                {navigation.map((item) => (
                                    <DisclosureButton key={item.name} as="a" href={item.href} className="block Montserrat-font text-[#1b7261] font-medium text-[16px] p-[18px] hover:text-[#051145]">
                                        {item.name}
                                    </DisclosureButton>
                                ))}
                            </div>
