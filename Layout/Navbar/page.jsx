...
const Navbar = ({ scrollToBiodataForm }) => {
    ...
    return (
        <>
            ...
            <div className='bg-[#1b7261] py-3 hidden lg:block'>
                    ...
                    <div className='flex justify-between'>
                        <div className='flex gap-7'>
                            <div className='flex items-center justify-center'>
                                ...
                                <span className='text-[14px] text-[#ffff] hover:text-[#75AAA0] ml-1'>(+245) 592 1125</span>
                            </div>
                            ...
                            <div className='flex items-center justify-center'>
                                ...
                                <span className='text-[14px] text-[#ffff] hover:text-[#75AAA0] ml-1'>rrdevs@support.com</span>
                            </div>
                        </div>
                    ...
                    <>
                                    ...
                                    <div className="hidden md:flex space-x-6">
                                        {navigation.map((item) => (
                                            <a key={item.name} href={item.href} className={classNames(
                                                'text-[#1b7261] font-medium text-[16px] p-[18px] hover:text-[#051145]'
                                            )}>{item.name}</a>
                                        ))}
                                    </div>
                                </div>
                        ...
                        <DisclosurePanel className="md:hidden">
                            <div className="space-y-1 px-2 pt-2 pb-3">
                                {navigation.map((item) => (
                                    <DisclosureButton key={item.name} as="a" href={item.href} className="block text-[#1b7261] font-medium text-[16px] p-[18px] hover:text-[#051145]">
                                        {item.name}
                                    </DisclosureButton>
                                ))}
                            </div>
