                    ...
                    <div className='w-full md:w-[59%] lg:w-[22%]'>
                        ...
                        <div className='flex flex-col'>
                            <div className='flex items-center py-2'>
                                ...
                                <span className='text-[14px] text-[#ffff] hover:text-[#051145] ml-1'>(+245) 592 1125</span>
                            </div>
                            ...
                            <div className='flex items-center py-2'>
                                ...
                                <span className='text-[14px] text-[#ffff] hover:text-[#051145]  ml-1'>rrdevs@support.com</span>
                            </div>
                            ...
                            <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span className='text-[14px] text-[#ffff] hover:text-[#051145] ml-1'>Main Raod, Surat 39608</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className='bg-[#051145] py-[30px]'>
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <p className='text-[#FFFF]'>
                        <span className='text-[#1B7261] font-bold'>©weddingbiodata</span> 2025. All rights reserved.
                    </p>
                    </div>
                </div>
            </div>
