                ...
                <div className='mx-auto max-w-7xl px-4 py-5 sm:px-6 lg:px-8 flex flex-wrap md:grid md:grid-cols-2 lg:flex lg:justify-between gap-6'>
                    ...
                    <div className='w-full md:w-[59%] lg:w-[20%]'>
                        ...
                        <ul className='flex flex-col items-stretch lg:items-center'>
                            <Link href={"/"} className='w-[50%] text-[white] font-medium py-2 px-2 hover:text-[#051145] OpenSans-font'>Home</Link>
                            <Link href={"/about-us"} className='w-[50%] text-[white] font-medium py-2 px-2 hover:text-[#051145] OpenSans-font'>About Us</Link>
                            <Link href={"/contact-us"} className='w-[50%] text-[white] font-medium py-2 px-2 hover:text-[#051145] OpenSans-font'>Contact Us</Link>
                        </ul>
                    </div>
