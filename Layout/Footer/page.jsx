        ...
        <>
            <div className='bg-[#1B7261] py-[30px]'>
                <div className='mx-auto max-w-7xl px-4 py-5 sm:px-6 lg:px-8 flex flex-wrap md:grid md:grid-cols-2 lg:flex lg:justify-between gap-6'>
                    ...
                    <div className='w-full md:w-[75%] lg:w-[30%]'>
                        ...
                        <p className='text-[white] font-medium my-3 Montserrat-font'>
                    ...
                    <div className='w-full md:w-[59%] lg:w-[20%]'>
                        ...
                        <ul className='flex flex-col items-stretch lg:items-center'>
                            <Link href={"/"} className='w-[50%] text-[white] font-medium py-2 px-2 hover:text-[#051145] Montserrat-font'>Home</Link>
                            <Link href={"/about-us"} className='w-[50%] text-[white] font-medium py-2 px-2 hover:text-[#051145] Montserrat-font'>About Us</Link>
                            <Link href={"/contact-us"} className='w-[50%] text-[white] font-medium py-2 px-2 hover:text-[#051145] Montserrat-font'>Contact Us</Link>
                        </ul>
                    </div>
                    ...
                    <div className='w-full md:w-[59%] lg:w-[22%]'>
                        ...
                        <div className='flex flex-col'>
                            <div className='flex items-center py-2'>
                                ...
                                <span className='text-[14px] text-[#ffff] hover:text-[#051145] ml-1 Montserrat-font'>(+245) 592 1125</span>
                            </div>
                            ...
                            <div className='flex items-center py-2'>
                                ...
                                <span className='text-[14px] text-[#ffff] hover:text-[#051145] ml-1 Montserrat-font'>rrdevs@support.com</span>
                            </div>
                            ...
                            <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span className='text-[14px] text-[#ffff] hover:text-[#051145] ml-1 Montserrat-font'>Main Raod, Surat 39608</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className='bg-[#051145] py-[30px]'>
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <p className='text-[#FFFF] Montserrat-font'>
                        <span className='text-[#1B7261] font-bold Montserrat-font'>©weddingbiodata</span> 2025. All rights reserved.
                    </p>
                    </div>
                </div>
            </div>
