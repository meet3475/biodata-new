    ...
    <>
      ...
      <div className="relative bg-[#F6F8FF] pt-[120px] pb-[120px] overflow-visible">
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none z-0">
          <div className="absolute top-[35%] left-[0%] hidden 2xl:block animate-float-slow">
          ...
          <div className="absolute top-[20%] left-[15%] animate-float-fast">
          ...
          <div className="grid lg:grid-cols-2 items-center gap-8">
            ...
            <div className="relative animate-fade-in delay-400">
              ...
              <Image
                ...
                width={100}
                height={100}
                className="absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2 hidden xl:block animate-float-medium"
              />
              <Image
              ...
              <Image
                ...
                width={215}
                height={350}
                className="absolute bottom-[-7%] left-[-4%] hidden md:block rounded-[40%] animate-float-fast"
              />
              <Image
                ...
                width={260}
                height={400}
                className="absolute bottom-[-9%] left-[-8%] opacity-40 hidden md:block animate-float-fast"
              />
            </div>
          </div>
        </div>
